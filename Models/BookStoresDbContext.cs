...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=.\\SQLExpress;Database=BookStoresDB;Persist Security Info=False;Encrypt=False;Trusted_Connection=True;TrustServerCertificate=False;Connection Timeout=30;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Author>(entity =>
        {
            entity.HasKey(e => e.AuthorId).HasName("PK__Author__86516BCF6A78FC50");
        ...
        {
            entity.HasKey(e => e.BookId).HasName("PK__Book__490D1AE14DEA1AEE");
        ...
        {
            entity.HasKey(e => e.JobId).HasName("PK__Job__6E32B6A5B2D534FC");
        ...
        {
            entity.HasKey(e => e.PubId).HasName("PK__Publishe__2515F2222A964BD1");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Role__760965CC16EB099A");
